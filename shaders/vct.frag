...
#define DIFFUSE_INDIRECT_FACTOR 1.0f
...
vec3 indirectDiffuseLight(vec3 color, vec3 normal){
	...
	// Return result.
	return DIFFUSE_INDIRECT_FACTOR * acc * (color + vec3(0.001f));
}
